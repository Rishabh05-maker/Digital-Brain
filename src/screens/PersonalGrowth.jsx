...
const PersonalGrowth = () => {
    ...
    const saveNote = () => {
        if (noteTitle.trim() && noteContent.trim()) {
            // Add the note functionality here
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <header className="PersonalHeader mb-8 bg-cover bg-center p-8 text-white rounded-lg shadow-md" style={{ backgroundImage: `url('https://images.pexels.com/photos/807598/pexels-photo-807598.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')` }}>
                <h1 className='text-3xl font-serif font-bold mb-2'>Personal Growth & Well-being</h1>
            ...
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
                    <div className='flex items-center gap-2'>
                        <label htmlFor=""><BsCardHeading className="text-gray-600" /></label>
                        <input
                    ...
                    <div className='flex items-center gap-2'>
                        <label htmlFor=""><MdCategory className="text-gray-600" /></label>
                        <input
                            className='border border-gray-300 rounded px-3 py-2 w-full focus:border-blue-500'
                            type="text"
                    ...
                    <div className='flex items-center gap-2'>
                        <label htmlFor=""><FaLink className="text-gray-600" /></label>
                        <input
                            className='border border-gray-300 rounded px-3 py-2 w-full focus:border-blue-500'
                ...
                <div className='mb-6'>
                    <div className='flex items-center gap-2 mb-2'>
                        <label htmlFor=""><SiNotepadplusplus className="text-gray-600" /></label>
                        <input
                            className='border border-gray-300 rounded px-3 py-2 w-full focus:border-blue-500'
                            placeholder='Title'
                            type="text"
            ...
            <footer className='footer mt-8 text-center'>
                <p className='font-serif text-gray-600'>Your professional success and quality of life directly depend on your ability to manage the information around you</p>
            </footer>
        </div>
    );
};
