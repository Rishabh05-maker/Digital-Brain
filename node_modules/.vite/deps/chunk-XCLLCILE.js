...
var useFocusController = function useFocusController2() {
  ...
  var ref = (0, import_react6.useRef)(shards);
  ref.current = shards;
...
var useFocusScope = function useFocusScope2() {
  var scope = (0, import_react6.useContext)(focusScope);
  if (!scope) {
...
var useFocusState = function useFocusState2(callbacks) {
  ...
  var _useState = (0, import_react7.useState)(false), active = _useState[0], setActive = _useState[1];
  var _useState2 = (0, import_react7.useState)(""), state = _useState2[0], setState = _useState2[1];
  var ref = (0, import_react7.useRef)(null);
  var focusState = (0, import_react7.useRef)({});
  var stateTracker = (0, import_react7.useRef)(false);
  (0, import_react7.useEffect)(function() {
    if (ref.current) {
  ...
  var onFocus3 = (0, import_react7.useCallback)(function(e) {
    focusState.current = {
      focused: true,
...
export {
  ...
  exportSidecar,
  Lock_default,
  AutoFocusInside_default,
  useFocusInside,
  MoveFocusInside_default,
  FreeFocusInside_default,
  useFocusController,
  useFocusScope,
  useFocusState,
  es2015_default
};
//# sourceMappingURL=chunk-XCLLCILE.js.map
